...
# load photo links
with open("/home/ubuntu/data/street2shop/photos.txt") as f:
    img_links = f.readlines()

with open("/home/ubuntu/clothes/street2shop/load_data/useful_photo_ids.json", "r") as f:
...
img_links = list(filter(lambda x: x[1].split(".")[-1].startswith("jpg"), img_links))

os.chdir("/home/ubuntu/data/street2shop/photos")
